...
<body>
    <div class="login-container">
        ...
        <div style="margin-bottom: 1.5rem;">
            <button type="button" onclick="window.location.href='{{ route('auth.google') }}'" style="width: 100%; background: #4285f4; color: white; padding: 0.75rem; border: none; border-radius: 4px; cursor: pointer; display: flex; align-items: center; justify-content: center;">
