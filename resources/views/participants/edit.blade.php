...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('participants.show', $participant) }}">{{ $participant->full_name }}</a></li>
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        ...
                        Editar Integrante: {{ $participant->full_name }}
                    </h3>
                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control @error('phone') is-invalid @enderror"
                                           id="phone" name="phone" value="{{ old('phone', $participant->phone) }}" placeholder="+56 9 XXXX XXXX">
                                    @error('phone')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('educational_entity_id') is-invalid @enderror"
                                        ...
                                        @foreach($educationalEntities as $entity)
                                            <option value="{{ $entity->id }}" {{ old('educational_entity_id', $participant->educational_entity_id) == $entity->id ? 'selected' : '' }}>
                                                {{ $entity->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('registration_date') is-invalid @enderror"
                                           ...
                                           value="{{ old('registration_date', $participant->registration_date ? $participant->registration_date->format('Y-m-d') : date('Y-m-d')) }}">
